...
(cond ((eq system-type 'darwin)
       (setq doom-font (font-spec :family "Monaco" :size (if (> (display-pixel-width) 1920) 24 12) :weight 'regular)
             doom-variable-pitch-font (font-spec :family "Sarasa Mono SC Nerd" :size (if (> (display-pixel-width) 1920) 24 12))))
      ((eq system-type 'gnu/linux) (setq doom-font (font-spec :family "JetBrainsMono Nerd Font Mono" :size (if (> (display-pixel-width) 1920) 24 12) :weight 'regular)
